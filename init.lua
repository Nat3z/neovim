-- Based off of Kickstart for simplicity :3
--
...
-- Load keymaps from user prefs after leader is configured.
require 'keymaps'
...
-- Let the editor/statusline use the last row instead of reserving an empty
-- command line above the tmux status bar.
vim.opt.cmdheight = 0
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('g?', vim.lsp.buf.hover, 'Hover Documentation')
